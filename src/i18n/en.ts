export const en = {
  ...
  share: {
    ...
    title: 'Share results',
    linkTitle: 'Link',
    linkHint: 'The whole tournament travels inside the link. Nothing is uploaded anywhere.',
    copyLink: 'Copy link',
    shorten: 'Shorten link',
    shortening: 'Shortening…',
    shortenHint:
      'A short link is made by a free outside service, which means this tournament is uploaded to it. The long link stays on your device.',
    shortened: 'Short link ready',
    shortenFailed: 'No shortening service answered. The long link still works.',
    shortenTooLong: 'This tournament is too large to shorten.',
    showLong: 'Show the long link',
    ...
    saveCopy: 'Save a copy here',
    saveCopyDone: 'Saved to this device',
